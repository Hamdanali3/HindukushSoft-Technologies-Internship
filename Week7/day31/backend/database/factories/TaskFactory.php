...
class TaskFactory extends Factory
{
    ...
    /**
     * Realistic, English sample task titles + matching descriptions,
     * used instead of Faker's default Latin lorem-ipsum text so seeded
     * data actually reads naturally in the UI.
     */
